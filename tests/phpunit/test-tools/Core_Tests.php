...
class Core_Tests extends Base\TestCase {
	...
	public function test_i18n() {
		...
		\WP_Mock::onFilter( 'plugin_locale' )->with( 'en_US', 'wordpress-primary-category' )->reply( 'en_US' );
		\WP_Mock::userFunction( 'load_textdomain', array(
			'times' => 1,
			'args' => array( 'wordpress-primary-category', 'lang_dir/wordpress-primary-category/wordpress-primary-category-en_US.mo' ),
		) );
		...
		\WP_Mock::userFunction( 'load_plugin_textdomain', array(
			'times' => 1,
			'args' => array( 'wordpress-primary-category', false, 'path/languages/' ),
		) );
	...
	public function test_init() {
		// Setup
		\WP_Mock::expectAction( 'wordpress_primary_category_init' );
