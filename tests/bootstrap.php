...
if ( ! defined( 'WORDPRESS_PRIMARY_CATEGORY_DIR' ) ) {
	define( 'WORDPRESS_PRIMARY_CATEGORY_DIR', __DIR__ . '/' );
}
...
if ( ! defined( 'WORDPRESS_PRIMARY_CATEGORY_PATH' ) ) {
	define( 'WORDPRESS_PRIMARY_CATEGORY_PATH', 'path' );
}
